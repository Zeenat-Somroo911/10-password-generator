...
export default function GeneratePassword() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-600 to-gray-700">
      

      {/* Center the password generator card within the screen */}
      <Card className="w-full max-w-md p-6 bg-shadow-lg rounded-lg">
        <div className="mx-auto max-w-md space-y-6">
          {/* Header with title and description */}
          <div className="space-y-2 text-center">
            <h2 className="text-3xl font-bold italic text-gray-800">Password Generator</h2>
          ...
          <div className="space-y-4">
            ...
            <Button type="button" className="w-full bg-blue-600 text-white hover:bg-blue-700" onClick={generatePassword}>
              Generate Password
            </Button>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                <Input
                  ...
                  className="flex-1"
                />
                <Button type="button" onClick={copyToClipboard} className="bg-green-800 text-white hover:bg-orange-700">
                  Copy to Clipboard
                </Button>
              </div>
            </div>
      ...
      <footer className="mt-6 text-center text-black-900">
